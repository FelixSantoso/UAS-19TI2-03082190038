...
namespace Hotel.UI
{
    public partial class Pembatalan : Form
    {
        ...
        private void Pembatalan_Load(object sender, EventArgs e)
        {
            loadDataBooking();
        }
        ...
        {
            dgvBooking.Rows.Add(obj.Tipe, obj.TipeBed, obj.Lantai, obj.NoKamar, obj.ExtraBed, obj.Harga, obj.Identitas, obj.Status);
        }
        ...
        {
            DialogResult dr = MessageBox.Show("Cancel?", "Cancel", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (dr == DialogResult.Yes)
            {
                try
                {
                    if(txtStatus.Text.Trim() == "Check In")
                    {
                        MessageBox.Show("Booking can't be canceled");
                    }
                    else if(txtStatus.Text.Trim() == "Check Out")
                    {
                        MessageBox.Show("Booking can't be canceled");
                    }
        ...
        {
            DataGridViewRow baris = dgvBooking.Rows[e.RowIndex];
